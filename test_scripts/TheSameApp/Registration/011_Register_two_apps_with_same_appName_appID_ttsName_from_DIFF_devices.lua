...
local appParams = {
  [1] = { appName = "Test Application", appID = "0001", fullAppID = "0000001", ttsName = "TtsName" },
  [2] = { appName = "Test Application", appID = "0001", fullAppID = "0000001", ttsName = "TtsName" }
}

--[[ Local Functions ]]
function registerAppEx(pAppId, pAppParams, pMobConnId)
