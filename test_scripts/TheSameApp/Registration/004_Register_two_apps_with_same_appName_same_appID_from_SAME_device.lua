...
--   SDL does:
-- 1) Send RegisterAppInterface(resultCode = "APPLICATION_REGISTERED_ALREADY") response to Mobile
---------------------------------------------------------------------------------------------------
...
runner.Step("Register App2 from device 1", registerAppFromSameDevice, {2, appParams[1], 1})
