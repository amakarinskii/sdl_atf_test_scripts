...
runner.Step("App 1 from Mobile 1 requests Unsubscribe from Ok button", unsubscribeButton, {1, "OK" })
runner.Step("HMI send OnButtonEvent and OnButtonPress for OK", sendOnButtonEventPress, {2, 1, "OK", "one"})
runner.Step("App 2 from Mobile 2 requests Unsubscribe from Ok button", unsubscribeButton, {2, "OK" })
runner.Step("HMI send OnButtonEvent and OnButtonPress for OK", sendOnButtonEventPress, {2, 1, "OK", "none"})
