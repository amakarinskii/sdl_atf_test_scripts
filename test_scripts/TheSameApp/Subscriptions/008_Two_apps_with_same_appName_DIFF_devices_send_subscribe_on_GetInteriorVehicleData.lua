...
-- local pReqRadioPayload = { moduleData = { moduleType = "RADIO" }, isSubscribed = true }
-- local pRspRadioPayload = { moduleData = { moduleType = "RADIO" }, isSubscribed = true,
--                            success = true, resultCode = "SUCCESS" }
-- local pReqClimatePayload = { moduleData = { moduleType = "CLIMATE" }, isSubscribed = true }
-- local pRspClimatePayload = { moduleData = { moduleType = "CLIMATE" }, isSubscribed = true,
--                            success = true, resultCode = "SUCCESS" }

-- local pNotificationRadioPayload   = { moduleData = { moduleType = "RADIO", radioControlData = { radioEnable = true }}}
-- local pNotificationClimatePayload = { moduleData = { moduleType = "CLIMATE", climateControlData = { fanSpeed = 50 }}}
