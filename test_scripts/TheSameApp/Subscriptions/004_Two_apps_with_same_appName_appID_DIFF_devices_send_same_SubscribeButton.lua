...
local function sendOnWayPointChange(pAppId1, pAppId2, pButtonName, pNumberOfDevicesSubscribed)
  ...
  common.hmi.getConnection():SendNotification("Navigation.OnButtonEvent",
...
runner.Step("HMI send OnWayPointChange for WayPoints",      sendOnWayPointChange, {1, 2, "WayPoints", "one"})
...
runner.Step("HMI send OnWayPointChange for WayPoints",      sendOnWayPointChange, {2, 1, "WayPoints", "two"})
