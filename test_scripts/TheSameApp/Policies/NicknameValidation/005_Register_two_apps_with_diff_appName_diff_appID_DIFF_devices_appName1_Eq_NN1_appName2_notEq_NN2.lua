...
-- local appParams = common.getRequestParams()
-- appParams.fullAppID = "1234567"
...
runner.Step("Register App2 from device 2", common.registerAppExNegative, {2, appParams[2], 2})
