...
-- Description: User consent for functional groups has no incorrect positive influence on functional groups
...
--   send to SDL valid SendLocation and Show RPC requests
-- SDL does:
-- 1)Send SendLocation(resultCode = USER_DISALLOWED) response to Mobile №1
...
--   Send Show(resultCode = USER_DISALLOWED) response to Mobile №2
-- 4)Send SendLocation(resultCode = SUCCESS) response to Mobile №1
--   Send SendLocation(resultCode = SUCCESS) response to Mobile №2
--   Send Show(resultCode = SUCCESS) response to Mobile №1
--   Send Show(resultCode = USER_DISALLOWED) response to Mobile №2
-- 5)Send SendLocation(resultCode = SUCCESS) response to Mobile №1
--   Send SendLocation(resultCode = SUCCESS) response to Mobile №2
--   Send Show(resultCode = SUCCESS) response to Mobile №1
