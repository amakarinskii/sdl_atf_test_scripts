...
runner.Step("Disallow group Group002 for App1 on device 2", common.funcGroupConsentForApp, {"ConsentGroup002",false, 2})
runner.Step("Disallow group Group001 for App1 on device 2", common.funcGroupConsentForApp, {"ConsentGroup001",false, 2})
runner.Step("Disallow group Group002 for App1 on device 1", common.funcGroupConsentForApp, {"ConsentGroup002",false, 1})
runner.Step("Disallowed SendLocation (Group001) from App1 from device 1", common.sendLocation, {1, "DISALLOWED"})
runner.Step("Disallowed SendLocation (Group001) from App1 from device 2", common.sendLocation, {2, "DISALLOWED"})
runner.Step("Disallowed Show (Group002) from App1 from device 1", common.show, {1, "DISALLOWED"})
...
runner.Step("Allow group Group002 for App1 on device 1", common.funcGroupConsentForApp, {"ConsentGroup002",true, 1})
runner.Step("Succeed SendLocation (Group001) from App1 from device 1", common.sendLocation, {1, "SUCCESS"})
runner.Step("Disallowed SendLocation (Group001) from App1 from device 2", common.sendLocation, {2, "DISALLOWED"})
...
runner.Step("Allow group Group002 for App1 on device 2", common.funcGroupConsentForApp, {"ConsentGroup002",true, 2})
runner.Step("Succeed SendLocation (Group001) from App1 from device 1", common.sendLocation, {1, "SUCCESS"})
runner.Step("Succeed SendLocation (Group001) from App1 from device 2", common.sendLocation, {2, "SUCCESS"})
runner.Step("Succeed Show (Group002) from App1 from device 1", common.show, {1, "SUCCESS"})
runner.Step("Succeed Show (Group002) from App1 from device 2", common.show, {2, "SUCCESS"})

runner.Step("Disallow group Group001 for App1 on device 1", common.funcGroupConsentForApp, {"ConsentGroup001",true, 1})
runner.Step("Disallowed SendLocation (Group001) from App1 from device 1", common.sendLocation, {1, "DISALLOWED"})
runner.Step("Succeed SendLocation (Group001) from App1 from device 2", common.sendLocation, {2, "SUCCESS"})
runner.Step("Succeed Show (Group002) from App1 from device 1", common.show, {1, "SUCCESS"})
runner.Step("Succeed Show (Group002) from App1 from device 2", common.show, {2, "SUCCESS"})

runner.Step("Disallow group Group001 for App1 on device 2", common.funcGroupConsentForApp, {"ConsentGroup001",true, 2})
runner.Step("Disallowed SendLocation (Group001) from App1 from device 1", common.sendLocation, {1, "DISALLOWED"})
runner.Step("Disallowed SendLocation (Group001) from App1 from device 2", common.sendLocation, {2, "DISALLOWED"})
runner.Step("Succeed Show (Group002) from App1 from device 1", common.show, {1, "SUCCESS"})
runner.Step("Succeed Show (Group002) from App1 from device 2", common.show, {2, "SUCCESS"})

runner.Step("Disallow group Group002 for App1 on device 2", common.funcGroupConsentForApp, {"ConsentGroup001",true, 2})
runner.Step("Disallowed SendLocation (Group001) from App1 from device 1", common.sendLocation, {1, "DISALLOWED"})
runner.Step("Disallowed SendLocation (Group001) from App1 from device 2", common.sendLocation, {2, "DISALLOWED"})
runner.Step("Succeed Show (Group002) from App1 from device 1", common.show, {1, "SUCCESS"})
runner.Step("Disallowed Show (Group002) from App1 from device 2", common.show, {2, "DISALLOWED"})
