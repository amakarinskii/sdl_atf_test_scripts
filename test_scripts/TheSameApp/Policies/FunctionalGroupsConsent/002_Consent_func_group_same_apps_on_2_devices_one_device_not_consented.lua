...
-- Description: User consent for functional groups of two mobile devices
--   (Mobile №1 is consented, Mobile №2 is not consented) with the same mobile applications registered
-- Precondition:
