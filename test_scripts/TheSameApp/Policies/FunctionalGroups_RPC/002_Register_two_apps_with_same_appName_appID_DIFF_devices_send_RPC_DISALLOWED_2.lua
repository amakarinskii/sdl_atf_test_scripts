...
runner.Step("Update of the default PT", createNewGroup, { appParams[2].fullAppID, "TestGroup_2", TestGroup_2 })
...
runner.Step("App1 sends 'AddCommand' RPC from Mobile 2, DISALLOWED", sendAddCommandRPC, { 2 })
runner.Step("App1 sends 'AddSubMenu' RPC from Mobile 1, DISALLOWED", sendAddSubMenuRPC, { 1 })
runner.Step("App1 sends 'AddSubMenu' RPC from Mobile 2, SUCCESS",    sendAddSubMenuRPC, { 2 })
