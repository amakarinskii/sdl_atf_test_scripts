...
-- 2) HMI sent only RADIO module capabilities to SDL
...
--   Check:
--    SDL sends "GetSystemCapability" response with RADIO module capabilities to mobile
---------------------------------------------------------------------------------------------------
...
runner.Title("Test")
runner.Step("GetSystemCapability Positive Case for RADIO", sendGetSystemCapability)
